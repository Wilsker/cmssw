...
class SiStripMonitorDigi : public DQMEDAnalyzer {
 ...
 private:
  ...
  MonitorElement *NApvShotsGlobal, *NApvShotsGlobalProf, *MedianChargeApvShotsGlobal, *NApvApvShotsGlobal, *StripMultiplicityApvShotsGlobal, *ShotsVsTimeApvShotsGlobal, *NumberOfFEDDigis;
