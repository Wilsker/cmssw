...
//      cout << "detid = " << detid << endl;
      ...
      /*for(unsigned int f=0; f<Fedconnections.size();f++){
        cout << "SiStripMonitorDigi::analyze: FED connection @ " << f << " FEDID = " << Fedconnections[f]->fedId() <<  endl;
        if(f>0){
          cout << "SiStripMonitorDigi::analyze: FED connection @ " << f-1 << " FEDID = " << Fedconnections[f-1]->fedId() << endl;
  ...
  if( FEDID_v_digisum.find(Fedconnections[0]->fedId()) != FEDID_v_digisum.end()){
    /*cout << "Found FED ID = " << Fedconnections[0]->fedId() << endl;
    cout << "Current # Digis = " << FEDID_v_digisum.find(Fedconnections[0]->fedId())->second << endl;
    cout << "Adding " << ndigi_det << endl;*/
    FEDID_v_digisum[Fedconnections[0]->fedId()] = FEDID_v_digisum.find(Fedconnections[0]->fedId())->second + ndigi_det;
    //cout << "Updated # digis = " << FEDID_v_digisum.find(Fedconnections[0]->fedId())->second << endl;
  }
  else{
    /*cout << "NEW FED ID = " << Fedconnections[0]->fedId() << endl;
    cout << "Current # Digis = " << FEDID_v_digisum.find(Fedconnections[0]->fedId())->second << endl;
    cout << "Adding = " << ndigi_det << endl;*/
    FEDID_v_digisum[Fedconnections[0]->fedId()] = ndigi_det;
    //cout << "Updated # digis = " << FEDID_v_digisum.find(Fedconnections[0]->fedId())->second << endl;
  }
